					...
					<div class="d-flex align-items-center">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb m-0 p-0">
                                ...
                                <li class="breadcrumb-item active"><a href="{{ route('mark.bonuses-history') }}">Bonus</a></li>
							</ol>
						</nav>
					</div>
				</div>
                ...
                <div class="col-md-12">
                    <div class="card border-dark">
                        <div class="card-header bg-dark">
                            <h3 class="text-white mb-0">Historique des bonus</h3>
                        </div>
    ...
    <script>
        $(function () {
            var table = $('.data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('mark.bonuses-history') }}",
                columns: [
                    {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                    {data: 'level_label', name: 'level_label'},
                    {data: 'godson_pseudo', name: 'godson_pseudo'},
