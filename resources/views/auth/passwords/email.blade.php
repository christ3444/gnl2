            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active" style="height: 256px">
                    ...
                    <div class="carousel-caption">
                        <h2 class="wow fadeInLeft">Requête de réinitialisation de mot de passe de connexion</h2>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <fieldset>
                        ...
                        {!! Form::open(['route' => 'password.email']) !!}
                            ...
                            <div class="form-group row {!! $errors->has('pseudo') ? 'has-error' : '' !!}">
                                ...
                                {!! Form::text('pseudo', old('pseudo'), ['class' => 'form-control', 'placeholder' => 'Entrer votre pseudo', 'autofocus' => true, 'required' => true]) !!}
                                {!! $errors->first('pseudo', '<small class="help-block">:message</small>') !!}
                            </div>
            
                            <div class="form-group row">
                                <div class="col-md-10 col-md-offset-1">
                                    {!! Form::submit('Envoyer le lien de réinitialisation du mot de passe', ['class' => 'btn btn-primary btn-block']) !!}
                                </div>
                            </div>
                        {!! Form::close() !!}
                    </fieldset>
